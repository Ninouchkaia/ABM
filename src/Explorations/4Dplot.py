...
with open('A:/Downloads/Projects/ABM/src/Explorations/20200727/ABM_Probabilistic NinaExploInAbsenceOfMonocytes-table.csv', 'r') as file_read :
...
zs = np.array(remainingCellRatioList)  
...
ax.set_zlabel('remainingCellRatioList')
